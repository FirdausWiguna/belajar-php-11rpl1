...
<form action="kwu-edit.php" method="POST">
      ...
      <input value="<?php echo $row["tanggal"]; ?>" type="date" name="tanggal" placeholder="Ex. 11-06-2004" /><br>

      <label for="pembeli">pembeli :</label><br>
      <input value="<?php echo $row["pembeli"]; ?>" type="text" name="pembeli" placeholder="Ex. yusuf" /><br>

      <label for="namabarang">namabarang :</label><br>
      <input value="<?php echo $row["namabarang"]; ?>" type="text" name="namabarang" placeholder="Ex. oreo" /><br>

      <label for="qty">qty :</label><br>
      <input value="<?php echo $row["qty"]; ?>" type="number" name="qty" placeholder="Ex. 10" /><br>

      <label for="hargabeli">hargabeli :</label><br>
      <input value="<?php echo $row["hargabeli"]; ?>" type="number" name="hargabeli" placeholder="Ex. 50000" /><br>

      <label for="hargajual">hargajual :</label><br>
      <input value="<?php echo $row["hargajual"]; ?>" type="number" name="hargajual" placeholder="Ex. 60000" /><br>
