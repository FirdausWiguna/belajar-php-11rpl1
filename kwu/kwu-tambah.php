...
<form action="kwu-tambah.php" method="POST">
    ...
    <input  type="date" name="tanggal" placeholder="Ex. 11-06-2004"/><br>

    <label for="namabarang"> namabarang :</label>
    <input  type="text" name="namabarang" placeholder="Ex. oreo"/> <br>

    <label for="pembeli"> pembeli :</label>
    <input  type="text" name="pembeli" placeholder="Ex. yusuf"/><br>

    <label for="qty"> qty :</label>
    <input  type="number" name="qty" placeholder="Ex. 10"/><br>

    <label for="hagabeli"> hargabeli :</label>
    <input  type="number" name="hargabeli" placeholder="Ex. 50000"/><br>

    <label for="hargajual"> hargajual :</label>
    <input  type="number" name="hargajual" placeholder="Ex. 60000"/><br>
